...
:::note In Umbraco 9 Events has been renamed to Notifications. This article is only relevant if you are using Umbraco 9. For Umbraco 8 see the [Subscribing to events article](../Subscribing-To-Events/) :::
